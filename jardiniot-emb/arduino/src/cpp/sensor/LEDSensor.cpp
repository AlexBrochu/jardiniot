...
LEDSensor::LEDSensor(int idController, std::vector<String> inputPins, std::vector<int> outputPins, int delay):SensorStrategy(idController, ControllerType::LED, inputPins, outputPins){
    ledPin = outputPins[0];
